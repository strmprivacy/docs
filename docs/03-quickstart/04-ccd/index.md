...
| Batch Job Agent       | A polling agent that communicates with the STRM Privacy Control Plane. Periodically checks whether new [batch jobs](/02-concepts/01-data-processing/03-batch-jobs.md) should be executed.                                                             |
